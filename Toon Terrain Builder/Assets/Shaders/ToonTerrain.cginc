...
{
	map.r = step(0.2, map.r - map.g - map.b - map.a);
	map.g = step(0.2, map.g - map.r - map.b - map.a);
	map.b = step(0.2, map.b - map.g - map.r - map.a);
	map.a = step(0.2, map.a - map.g - map.b - map.r);
	return map;
}
