...
Shader "ToonTerrain" {
    Properties{
        ...
        CGINCLUDE
#pragma surface surf SimpleLambert vertex:SplatmapVert nolightmap noambient finalcolor:SplatmapFinalColor finalprepass:SplatmapFinalPrepass finalgbuffer:SplatmapFinalGBuffer noinstancing addshadow
